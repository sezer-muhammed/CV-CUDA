...
bool ExternalBuffer::load(PyObject *o)
{
    ...
    else if (hasattr(tmp, "__dlpack__"))
    {
        ...
        // PyTorch is divergent on the __dlpack__ method specification.
        // By default, they will select a non-synchronization method for exporting
        // the capsule. This is to ensure that existing libraries using PyTorch can
        // continue to use CUDA graph capture. However, this is non-compliant with DLPack.
        // As such, we must explicitly pass the legacy default stream setup to the __dlpack__ method.
        // This explicit calling is compliant with the standard and means we do not
        // have to worry about diverging behavior (in this case it would be a bug in external libraries).
        // // Previous behavior (< 0.15.0):
        // // cap = tmp.attr("__dlpack__")(1).cast<py::capsule>();  // Legacy stream default
        // // Current behavior (0.16.0 internal)
        // // cap = tmp.attr("__dlpack__")().cast<py::capsule>();  // Allow library to choose default
        // This behavior is broken with PyNvVideoCodec which fills in zero when we call it here.
        // // Fixed behavior (0.16.0 release)
        // Always enforces the legacy stream default on the CV-CUDA side, compliant with DLPack.
        // DLPack Python Spec: https://dmlc.github.io/dlpack/latest/python_spec.html
        // DLPack 2022.12 Spec: https://data-apis.org/array-api/2022.12/API_specification/generated/array_api.array.__dlpack__.html
        // Torch Issue 1: https://github.com/pytorch/pytorch/pull/150217/files
        // Torch Issue 2: https://github.com/pytorch/pytorch/pull/163242
        // Discussion Thread on Torch Behavior: https://github.com/data-apis/array-api/issues/974
        py::capsule cap = tmp.attr("__dlpack__")("stream"_a = 1).cast<py::capsule>();
